<div class="min-h-screen bg-slate-50 py-12 dark:bg-slate-900">
    <div class="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8 text-center">
            <h1 class="text-3xl font-bold text-slate-900 dark:text-white">Edit Memorial</h1>
            <p class="mt-2 text-slate-600 dark:text-slate-400">Update {{ $memorial->pet_name }}'s memorial</p>
        </div>
                ...
                @if($currentStep === 4)
                    <div class="space-y-6">
                        ...
                        <div class="rounded-md bg-indigo-50 p-4 dark:bg-indigo-900/20">
                            <div class="flex">
                                <div class="ml-3">
                                    <h3 class="text-sm font-medium text-indigo-800 dark:text-indigo-300">Ready to save</h3>
                                    <div class="mt-2 text-sm text-indigo-700 dark:text-indigo-400">
                                        <p>Your changes to {{ $companionName }}'s memorial will be saved.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
