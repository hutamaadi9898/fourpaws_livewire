            ...
            <div class="w-full lg:w-1/2">
                ...
                <div class="mt-10 flex flex-col items-start gap-4 sm:flex-row sm:items-center sm:gap-6">
                    <!--[if BLOCK]><![endif]--><?php if(auth()->guard()->check()): ?>
                        <a href="<?php echo e(route('memorials.create')); ?>" class="w-full rounded-md bg-indigo-600 px-5 py-3 text-center text-base font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 sm:w-auto">
                            Create Memorial
                        </a>
                    <?php else: ?>
                        <a href="<?php echo e(route('register')); ?>" class="w-full rounded-md bg-indigo-600 px-5 py-3 text-center text-base font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 sm:w-auto">
                            Get Started Free
                        </a>
                        <a href="<?php echo e(route('login')); ?>" class="w-full rounded-md bg-white px-5 py-3 text-center text-base font-semibold text-slate-900 shadow-sm ring-1 ring-inset ring-slate-300 hover:bg-slate-50 sm:w-auto dark:bg-slate-800 dark:text-white dark:ring-slate-600 dark:hover:bg-slate-700">
                            Sign In
                        </a>
    ...
    <section class="py-24 sm:py-32">
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            <div class="mt-16 text-center">
                <!--[if BLOCK]><![endif]--><?php if(auth()->guard()->check()): ?>
                    <a href="<?php echo e(route('memorials.create')); ?>" class="inline-flex rounded-md bg-indigo-600 px-5 py-3 text-base font-semibold text-white shadow-sm hover:bg-indigo-500">
                        Create Your Memorial Now
                    </a>
                <?php else: ?>
                    <a href="<?php echo e(route('register')); ?>" class="inline-flex rounded-md bg-indigo-600 px-5 py-3 text-base font-semibold text-white shadow-sm hover:bg-indigo-500">
                        Get Started Free
                    </a>
                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
            </div>
        ...
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="relative isolate overflow-hidden bg-gradient-to-br from-indigo-600 to-purple-700 px-6 py-24 shadow-2xl sm:rounded-3xl sm:px-24 xl:py-32">
                ...
                <div class="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
                    <!--[if BLOCK]><![endif]--><?php if(auth()->guard()->check()): ?>
                        <a href="<?php echo e(route('memorials.create')); ?>" class="w-full rounded-md bg-white px-6 py-3 text-center text-base font-semibold text-indigo-600 shadow-sm hover:bg-indigo-50 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white sm:w-auto">
                            Create Memorial
                        </a>
                        <a href="<?php echo e(route('dashboard')); ?>" class="w-full rounded-md border-2 border-white px-6 py-3 text-center text-base font-semibold text-white hover:bg-white/10 sm:w-auto">
                            Go to Dashboard
                        </a>
                    <?php else: ?>
                        <a href="<?php echo e(route('register')); ?>" class="w-full rounded-md bg-white px-6 py-3 text-center text-base font-semibold text-indigo-600 shadow-sm hover:bg-indigo-50 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white sm:w-auto">
                            Get Started Free
                        </a>
                        <a href="<?php echo e(route('login')); ?>" class="w-full rounded-md border-2 border-white px-6 py-3 text-center text-base font-semibold text-white hover:bg-white/10 sm:w-auto">
                            Sign In
                        </a>
                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                </div>
        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="flex flex-col items-center justify-between gap-4 sm:flex-row">
                <p class="text-sm text-slate-400">
                    © <?php echo e(date('Y')); ?> FourPaws. All rights reserved.
                </p>
                <div class="flex gap-6">
                    <a href="<?php echo e(route('privacy')); ?>" class="text-sm text-slate-400 hover:text-white">
                        Privacy Policy
                    </a>
                    <a href="<?php echo e(route('terms')); ?>" class="text-sm text-slate-400 hover:text-white">
                        Terms of Service
                    </a>
                </div>
            </div>
...
<?php /**PATH C:\Users\hutam\Herd\fourpaws\resources\views/livewire/landing.blade.php ENDPATH**/ ?>